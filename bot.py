...
from aiogram.filters.command import RegexpCommandsFilter
...
# Одобрение заявки
@dp.message(RegexpCommandsFilter(regexp_commands=['approve_([0-9]+)']))
...
# Отклонение заявки
@dp.message(RegexpCommandsFilter(regexp_commands=['reject_([0-9]+)']))
